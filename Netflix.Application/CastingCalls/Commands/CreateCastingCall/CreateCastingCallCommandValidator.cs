...
{
    public class CreateCastingCallCommandValidator : AbstractValidator<CreateCastingCallCommand>
    {
        public CreateCastingCallCommandValidator()
        {
            ...
            // CreatedByDirectorId: Required
            RuleFor(x => x.CreatedByDirectorId)
                .NotEmpty().WithMessage("Created By Director ID is required.");
