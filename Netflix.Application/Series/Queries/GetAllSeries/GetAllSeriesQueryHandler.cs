...
{
    internal class GetAllSeriesQueryHandler : IRequestHandler<GetAllContentQuery<Domain.Series>, PagedResult<Netflix.Domain.Series>>
    {
        ...
        public Task<PagedResult<Domain.Series>> Handle(GetAllContentQuery<Domain.Series> request, CancellationToken cancellationToken)
        {
